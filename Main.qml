...
ApplicationWindow {
    ...
    Rectangle{//工具栏
        ...
        RowLayout{
            ...
            ToolButton{  //file action
                id:fileActionButton
                action: actions.fileAction
                highlighted: openActionButton.hovered?true:false
                onClicked: menuExport0.popup(0,30)//点击显示
                Menu{
                    id:menuExport0
                    MenuItem{
                        id:saveActionButton
            ...
            ToolButton{
                id:shotcutActionButton
                action: actions.shotcutAction
                highlighted: exportsActionButton.hovered?true:false
                onClicked: menuExport1.popup(0,30)//点击显示
